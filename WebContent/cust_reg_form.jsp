				...
				<div class="col-lg-12">
					...
					<div class="form-group ">
									...
									<div class="form-group ">
										...
										<div class="col-lg-10">
											<textarea readonly style="overflow:hidden;resize:none" class=" form-control" rows="1" cols="100" id="plan" name="plan" ><%=request.getParameter("plan_type") %></textarea>
										</div>
									</div>
